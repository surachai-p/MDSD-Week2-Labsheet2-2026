      ...
      body: const SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            InfoCard(
              title: 'คณะ', value: 'วิศวกรรมศาสตร์',
...
class AboutPage extends StatelessWidget {
  ...
  static const String _name = '116Nithi';
  static const String _studentId = '6xxxxxxxx';
  static const String _faculty = 'วิศวกรรมศาสตร์';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text('งานที่เหลือ: $remaining จาก ${_todos.length} งาน'),
            const Divider(),
            Expanded(
