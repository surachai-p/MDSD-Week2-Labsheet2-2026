...
class _GreetingFormState extends State<GreetingForm> {
  ...
  // 1. เพิ่มตัวแปรเก็บภาษาที่เลือก และรายการภาษา
  ...
  void _clear() {
    ...
    setState(() {
      _greeting = '';
      _error = '';
      _selectedLanguage = 'ไทย'; // คืนค่ากลับเป็นภาษาไทย
    });
  }
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          // 3. เพิ่ม DropdownButtonFormField สำหรับเลือกภาษา
          ...
          const SizedBox(height: 16), // เว้นช่องว่าง
          // TextField รับชื่อ (ของเดิม)
          TextField(
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            CircleAvatar(
              radius: 60, // ขนาดความกว้างของวงกลม
